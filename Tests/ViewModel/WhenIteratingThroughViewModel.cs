...
namespace Tests.ViewModel {
    [TestClass]
    public class WhenIteratingThroughViewModel {
        ...
        public void AddingElementWasLogged() {
            ...
            Assert.IsTrue(logger.WasLogged("Added element: 1 - 2"));
        }
        ...
        public void ElementDeletionWasLogged() {
            ...
            Assert.IsTrue(logger.WasLogged("Deleted element with key: 1"));
        }
        ...
        public void FindingElemtWasLogged() {
            ...
            Assert.IsTrue(logger.WasLogged("Found element: 1 - 2"));
        }
    }
}